...
func (c *authServiceClient) GetUserID(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*UserIDResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAuthServiceServer) GetUserID(context.Context, *TokenRequest) (*UserIDResponse, error) {
...
func _AuthService_GetUserID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetUserID(ctx, req.(*TokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
